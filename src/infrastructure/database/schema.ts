...
export const product_features = subscrioSchema.table(
  "product_features",
  {
    composition_rule: text("composition_rule")
      .notNull()
      .default("override_wins"),
    cross_subscription_rule: text("cross_subscription_rule")
      .notNull()
      .default("legacy"),
    id: bigserial("id", { mode: "number" }).primaryKey(),
...
export const plans = subscrioSchema.table(
  "plans",
  {
    id: bigserial("id", { mode: "number" }).primaryKey(),
    product_id: bigint("product_id", { mode: "number" })
...
export const plan_features = subscrioSchema.table(
  "plan_features",
  {
    id: bigserial("id", { mode: "number" }).primaryKey(),
...
export const subscriptions = subscrioSchema.table("subscriptions", {
  ...
  plan_id: bigint("plan_id", { mode: "number" })
    .notNull()
    .references(() => plans.id, { onDelete: "cascade" }),
  billing_cycle_id: bigint("billing_cycle_id", { mode: "number" })
    .notNull()
    .references(() => billing_cycles.id, { onDelete: "cascade" }),
...
export const subscriptionStatusView = subscrioSchema
...
export const subscription_feature_overrides = subscrioSchema.table(
  ...
  (table) => ({
    uniqueSubscriptionFeature: unique().on(
...
export const billing_cycles = subscrioSchema.table(
  "billing_cycles",
  {
    id: bigserial("id", { mode: "number" }).primaryKey(),
    plan_id: bigint("plan_id", { mode: "number" })
